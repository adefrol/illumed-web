...
export const ServiceSection: FC = () => {
  return (
    <div className="lg:h-[50vh] flex flex-col justify-center">
      <div className="text-center flex flex-col gap-5">
        <Title title="услуги" />
        <p className="font-extralight text-[calc(18px+12*(100vw-320px)/1920)] lg:w-2/3 mx-auto">
          Студия{" "}
          <span className={jost.className}>
            illumed<span className="text-violet-400">Web</span>
          </span>{" "}
          полностью реализует современные проекты, используя спектр нескольких
          необходимых услуг
        </p>
      </div>

      <div className="grid place-items-center md:grid-cols-2 lg:grid-cols-3 lg:gap-0 gap-5 py-10">
